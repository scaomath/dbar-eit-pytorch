...
The initial porting draft of the MATLAB code based on KIT4 on circular domain is done by GPT Codex 5.3 using VSCode Copilot. The `numpy`-based iterative method in https://github.com/eitcom/pyEIT and FFT-based codes in https://github.com/NablaIP/pydbar are also references.
